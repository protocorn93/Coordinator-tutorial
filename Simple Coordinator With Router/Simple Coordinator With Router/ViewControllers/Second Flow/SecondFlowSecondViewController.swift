//
//  SecondFlowSecondViewController.swift
...
class SecondFlowSecondViewController: UIViewController, Storyboarded {
    ...
    @IBAction func handleNextButton(_ sender: UIButton) {
        navigationDelegate?.handleNavigationToSecondFlowLastViewController()
    }
